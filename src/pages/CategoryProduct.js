...
const CategoryProduct = () => {
  ...
  // Initialize filterCategoryList with categories from URL parameters
  ...
  const handleSelectCategory = (category) => {
    if (filterCategoryList.includes(category)) {
      setFilterCategoryList(filterCategoryList.filter((cat) => cat !== category));
    } else {
  ...
  return (
    <div className="container mx-auto p-4">
      <TemporaryDrawer handleSortBy={handleSortBy} handleSelectCategory={handleSelectCategory} />
      <div className="px-4">
